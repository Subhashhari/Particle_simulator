...
public class SimulationUI extends Application {
    ...
    private HBox createControls() {
        ...
        addEmitterButton.setOnAction(e -> {
            ...
            particleSystem.addEmitter(randomPosition(), 10.0f, 30.0f, 1.0f, "Blue");
        });
    ...
    private void update() {
        ...
        particleSystem.updateParticlesPosition();
    }
    ...
    private void render() {
        ...
        for (Particle particle : particles) {
            gc.fillOval(particle.getPosition().get(0), particle.getPosition().get(1), 5, 5); // Render particle as a small circle
        }
